...
void RotarySliderWithLabels::paint(juce::Graphics& g)
{
	...
	//Use these to debug sliders size
...
void ResponseCurveComponent::resized()
{
	...
	Array<float> freqs
	{
		20,50,100,200,500,1000,2000,4000,5000,10000,20000
	};
...
void ResponseCurveComponent::timerCallback()
{
	...
	/*
	if there are FFT data buffers to pull if we can pull a buffer generate a pth
	*/

	const auto fftBounds = getAnalysisArea().toFloat();
	const auto fftSize = leftChannelFFTDataGenerator.getFFTSize();
	/*
	48000 / 2048 =23Hz <- this is out bin width
	*/
	...
	/*
	while there are paths tha can be pulled, pull as many as we can
...
SimpleEQAudioProcessorEditor::SimpleEQAudioProcessorEditor(SimpleEQAudioProcessor& p)
	...
	peakFreqSlideraAttachment(audioProcessor.apvts, "Peak Freq", peakFreqSlider),
	peakGainSlideraAttachment(audioProcessor.apvts, "Peak Gain", peakGainSlider),
