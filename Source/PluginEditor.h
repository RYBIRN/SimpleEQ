...
struct FFTDataGenerator
{
	...
	*/
	...
	{
		//When you change order, recreate the window, forwardFFT, fiifo, fftData
...
struct AnalyzerPathGenerator
{
	...
	*/
					  ...
					  float negativeInfinity)
	{
		...
		const int pathResolution = 2; //you can draw lin-to's every 'pathResolution' pixels
...
private:
	...
	Attachment peakFreqSlideraAttachment,
		peakGainSlideraAttachment,
		peakQualitySlideraAttachment,
		lowCutFreqSlideraAttachment,
